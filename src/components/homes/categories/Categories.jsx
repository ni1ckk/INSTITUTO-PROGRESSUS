          ...
          <div className="row justify-center text-center">
            <div className="col-auto">
              <div className="sectionTitle ">
                <h2 className="sectionTitle__title ">Todos os Cursos</h2>

                <p className="sectionTitle__text ">
                  Com diversas opções para cada necessidade
                </p>
              </div>
            </div>
          </div>
            ...
            {showSlider && (
              ...
              >
                {topCategories.map((item, i) => (
                    ...
                    //<SwiperSlide key={i}></SwiperSlide></Swiper> era o que tinha antes
